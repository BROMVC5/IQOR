...
<head>
    ...
    <title>iQOR | Time Off Code Information</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Time Off Code Information</h1>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmtimeoff.asp" method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmtimeoff_det.asp');" />
...
<script>
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmtimeoff.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function go(str) {
     ...
     function exportReport() {
        ...
        window.open("tmexcel_timeoff.asp?" + sURL);
	}
