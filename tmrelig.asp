...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmrelig.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmrelig_det.asp');" />
    ...
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmrelig.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function exportReport() {
        ...
        window.open("tmexcel_relig.asp?" + sURL);
	}
