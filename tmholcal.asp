...
<head>
    ...
    <title>iQOR | Holiday Group Information</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Holiday Group Information</h1>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmholcal.asp" method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmholcal_det.asp');" />
...
<script>
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmholcal.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function exportReport() {
        ...
        window.open("tmexcel_holcal.asp?" + sURL);
	}
</script>
