...
<head>
    ...
    <title>iQOR | Holiday Dates Information</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Holiday Dates Information</h1>
            </section>
            <!-- Main content -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmholiday.asp" method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmholiday_det.asp');" />
                                        ...
                                        <div class="col-sm-3 pull-right">
                                            <div class="input-group">
                                                <input class="form-control" id="txtSearch" name="txtSearch" value="<%=sSearch%>" placeholder="Search" maxlength="30" type="text" />
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default" type="submit" name="search" value="Search" onclick="showContent('page=1');return false;">
...
<script>
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmholiday.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function exportReport() {
        ...
        window.open("tmexcel_hol.asp?" + sURL);
	}
