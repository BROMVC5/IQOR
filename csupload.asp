    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>Upload CSV Generate Subsidy</h1>
            </section>
            <!-- Main content -->
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <!-- form start -->
                        <form class="form-horizontal" action="csupload.asp" ENCTYPE="multipart/form-data" method="post">
                        	<!-- box box-info -->
...
<%
	...
	sFile = dtTemp & ".csv"
		...
		if o.Field("txtFile" & i).FileName <> "" then
			...
			sFileTo = Server.MapPath(".") & "\EXCEL\CS\"
			
			Dim fs 
			Set fs = CreateObject("Scripting.FileSystemObject")
			For Each File In fs.GetFolder(sFileTo).Files
				If fs.GetExtensionName(File) = "csv" Then
					fs.DeleteFile File
				End If
			Next
		
			o.FileInputName = "txtFile"
			o.FileFullPath = Server.MapPath(".") & "\EXCEL\CS\" & sFile
			o.save
