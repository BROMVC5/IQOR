...
<%
    ...
    sPanelCode = request("txtstring")
  
    if reqForm("btnSubmit") <> "" then
        sPanelCode = reqform("txtPanelCode")
        
        sSQL = "delete from mspanelc where PANELCODE ='" & sPanelCode & "'"
        conn.execute sSQL     
        
        sMainURL = "mspanelc.asp?"
        sAddURL = "txtPanelCode=" & sPanelCode & "&txtSearch=" & sSearch & "&Page=" & iPage 
...
<body>
    <form class="form-horizontal" action="mspanelc_del.asp" method="post">
        <input type="hidden" name="txtPanelCode" value='<%=sPanelCode%>' />
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>Panel Clinic : <% response.write sPanelCode %></h3></span>
