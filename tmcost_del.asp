...
<%
    ...
    sCOST_ID = request("txtstring")
  
    if reqForm("btnSubmit") <> "" then
        sID = reqform("txtCOST_ID")
        
        sSQL = "delete from TMCOST where COST_ID='" & sID & "'"
        conn.execute sSQL     
        
        sMainURL = "tmcost.asp?"
        sAddURL = "txtCost_ID=" & sID & "&txtSearch=" & sSearch & "&Page=" & iPage 
...
<body>
    <form class="form-horizontal" action="tmcost_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>Cost Center Code : <% response.write sCost_ID %></h3></span>
                    <span style="color:red"><h4>Are you sure to delete this Cost Center?</h4></span>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
