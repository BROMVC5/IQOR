...
<head>
    ...
    <title>iQOR | Religion Information</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Work Location Information</h1>
            </section>
            <!-- Main content -->
                            ...
                            <div class="box-body ">
                                <form name="form1" action="tmwork.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmwork_det.asp');" />
    ...
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmwork.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function exportReport() {
        ...
        window.open("tmexcel_work.asp?" + sURL);
	}
