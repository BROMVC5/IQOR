...
<head>
    ...
    <title>iQOR | Department Information</title>
...
function showContent(str) {
  	...
  	xhttp.open("GET", "ajax/ax_tmdept.asp?"+str, true);
  	xhttp.send();
}
...
function exportReport() {
        ...
        window.open("tmexcel_dept.asp?" + sURL);
	}
</script>
                            ...
                            <div class="box-body ">
                                <form name="form1" action="tmdept.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmdept_det.asp');" />
