...
function showContent(str) {
  	...
  	if (str.length == 0) { 
    	document.getElementById("shfcode_info").innerHTML = "";
    	return;
  	}
  	xhttp = new XMLHttpRequest();
  	xhttp.onreadystatechange = function() {
    	if (xhttp.readyState == 4 && xhttp.status == 200) {
      	document.getElementById("shfcode_info").innerHTML = xhttp.responseText;
    	}
  	};
  	
  	str = str + "&txtSearch=" + document.getElementById("txtSearch").value;
  	
  	xhttp.open("GET", "ajax/ax_tmshfcode.asp?"+str, true);
  	xhttp.send();
}
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmdept.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmshfcode_det.asp');" />
                                            </div>
                                         </div>
