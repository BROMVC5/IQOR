...
private sub pageHeader()
	...
	response.write "<table cellSpacing=0 cellpadding=0 width=800 >"
		response.write "<tr>"
			response.write "<td width=100 align=left>  Report : Subsidy Entitlement Detail</td>"
	...
	response.write "<table cellSpacing=0 cellpadding=0 width=800 >"
		...
		response.write "<tr>"
			...
			response.write "<td align=left width=80>Date</td>"
...
sSQL = sSQL & "order by tmemply.EMP_CODE asc "
...
if not rstCSTrns.eof then
	...
	do while not rstCSTrns.eof
		...
		if bPrint = true then
			...
			response.write "<td align=left width=150>" & rstCSTrns("NAME") & "</td>"
			bPrint = false
		else
		...
		response.write "<td align=left width=80>" & rstCSTrns("DT_SUB") & "</td>"
		response.write "<td align=right width=50>" & pFormatDash(rstCSTrns("AMOUNT"),2) & "</td>"
		response.write "</tr>"
