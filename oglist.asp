...
function showContent(str) {
  	...
  	str = str + "&List=" + document.getElementById("cboList").value;
  	
  	xhttp.open("GET", "ajax/ax_ogprop_list.asp?"+str, true);
  	xhttp.send();
}
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Outgoing Goods Pass List</h1>
            </section>
            <!-- Main content -->
                                ...
                                <form name="form1" action="ogprop.asp" method="POST">
                                    <div class="row">
                                            ...
                                            <div class="col-sm-3 pull-left">
				                             	<select id="cboList" name="cboList" class="form-control" onchange="showContent(this)">
	                                                <option value="Appr">Approved</option>
                                                    <option value="Ack">Completed</option>
	                                                <option value="Comp">Acknowledged</option>
	                                                <option value="Pend">Pending</option>
	                                                <option value="Rej">Rejected</option>
	                                                <option value="SRej">Rejected by Security</option>
                                         ...
                                         <div class="col-sm-3 pull-right">
                                            <div class="input-group">
                                                <input class="form-control" id="txtSearch" name="txtSearch" value="<%=server.HtmlEncode(sSearch)%>" placeholder="Search" maxlength="10" type="text" />
