        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <!-- form start -->
                        <form class="form-horizontal" action="msimportclinic.asp" ENCTYPE="multipart/form-data" method="post">
                        	<!-- box box-info -->
	...
	sFile = dtTemp & "." & sFileType
		...
		if o.Field("txtFile" & i).FileName <> "" then
			...
			For Each File In fs.GetFolder(sFileTo).Files
				If fs.GetExtensionName(File) = "xls" or fs.GetExtensionName(File) = "xlsx" or fs.GetExtensionName(File) = "xlsm" or fs.GetExtensionName(File) = "xlsb" Then
					fs.DeleteFile File
				End If
			Next
