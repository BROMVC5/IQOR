...
<%
    ...
    sWorkGrp_ID = request("txtstring")
  
    if reqForm("btnSubmit") <> "" then
        sID = reqform("txtWorkGrp_ID")
        
        sSQL = "delete from TMWORKGRP where WORKGRP_ID='" & sID & "'"
        conn.execute sSQL     
        
        sMainURL = "tmworkgrp.asp?"
        sAddURL = "txtWorkGrp_ID=" & sID & "&txtSearch=" & sSearch & "&Page=" & iPage 
...
<body>
    <form class="form-horizontal" action="tmworkgrp_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>Work Group : <% response.write sWorkGrp_ID %></h3></span>
                    <span style="color:red"><h4>Are you sure to delete this work group?</h4></span>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
