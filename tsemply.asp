...
function showContent(str) {
  	...
  	xhttp.open("GET", "ajax/ax_tsemply_info.asp?"+str, true);
  	xhttp.send();
}
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tsemply.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tsemply_det.asp');" />
                                            </div>
                                         </div>
