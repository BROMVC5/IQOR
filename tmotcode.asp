...
<head>
    ...
    <title>iQOR | Overtime Code</title>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmotcode.asp" method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmotcode_det.asp');" />
...
<script>
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmotcode.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function go(str) {
     ...
     function exportReport() {
        ...
        window.open("tmexcel_otcode.asp?" + sURL);
	}
