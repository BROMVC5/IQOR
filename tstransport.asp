...
function showContent(str) {
  	...
  	xhttp.open("GET", "ajax/ax_tstransport_info.asp?"+str, true);
  	xhttp.send();
}
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1> OT Transportation Arrangement </h1>
            </section>
            <!-- Main content -->
                            ...
                            <div class="box-body ">
                                <form name="form1" action="tsarea.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tstransport_det.asp');" />
                                            </div>
                                         </div>
