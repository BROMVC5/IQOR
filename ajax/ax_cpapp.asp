...
sql = sql & " where cpresv.approve = 'Y' "
if sql_1 <> "" then
	sql = sql & sql_1
end if 
            ...
            <div class="dataTables_paginate">
                <ul class="pagination">
                    <%IF Cint(PageNo) > 1 then %>
                        <li class="paginate_button"><a href="javascript:showApp('page=1');" class="button_a" ><< First</a></li>
                        <li class="paginate_button"><a href="javascript:showApp('page=<%=PageNo-1%>');" class="button_a" >< Back</a></li>
                    <%End IF%>
                    ...
                    <% if (intID >= (Cint(PageNo)-3)) and (intID <= (Cint(PageNo)+3)) Then%>
                        ...
                        <%Else%>
                            <li class="paginate_button"><a href="javascript:showApp('page=<%=intID%>');" class="button_a" ><%=intID%></a></li>
                        <%End IF%>
                    <%End IF%>
                    <%Next%>

                    <%IF Cint(PageNo) < TotalPage Then %>
                        <li class="paginate_button"><a href="javascript:showApp('page=<%=PageNo+1%>');" class="button_a" >Next ></a></li>
                        <li class="paginate_button"><a href="javascript:showApp('page=<%=TotalPage%>');" class="button_a" >Last >></a></li>
                    <%End IF%>
                </ul>
            </div>
        </div>
