...
if txtSearch <> "" then
	ScStr = txtSearch
 	ScStr = replace(ScStr,"'","''")
  	sql_1 = "and ((AREACODE like '%" & ScStr & "%') "
  	sql_1 = sql_1 & " or (AREA like '%" & ScStr & "%') "
  	sql_1 = sql_1 & " or (ROUTE like '%" & ScStr & "%')) "
end if
        ...
        <div class="row">
            ...
            <div class="col-sm-4 pull-right">
                <div class="input-group">
                    ...
                    <input class="form-control" id="txtSearch3" name="txtSearch3" value="<%=txtSearch%>" placeholder="Search" maxlength="30" type="text" />
                        <span class="input-group-btn">
                        <button class="btn btn-default" type="submit" name="search" value="Search" onclick="showDetails('page=1', 'AREA','mycontent');"><i class="fa fa-search"></i>
                        </button>
                    </span>
                </div>
            </div>
    ...
    <table id="example1" class="table table-bordered">
        ...
        <tbody>
            <%
                ...
                i = i + 1                             
                response.write "<tr onmouseover=this.bgColor='#FFF59D' onmouseout=this.bgColor='white' onclick=""getValue('" & server.HTMLEncode(rstTSArea("AREACODE")) & "', 'txtAreaCode')"">"
            ...
            <div class="dataTables_paginate">
                <ul class="pagination">
                    <%IF Cint(PageNo) > 1 then %>
                        <li class="paginate_button"><a href="javascript:showDetails('page=1', 'AREA','mycontent');" class="button_a" >
						&lt;&lt; First</a></li>
                        <li class="paginate_button"><a href="javascript:showDetails('page=<%=PageNo-1%>','AREA','mycontent');" class="button_a" >
						&lt; Back</a></li>
                    <%End IF%>
                    ...
                    <% if (intID >= (Cint(PageNo)-3)) and (intID <= (Cint(PageNo)+3)) Then%>
                        ...
                        <%Else%>
                            <li class="paginate_button"><a href="javascript:showDetails('page=<%=intID%>', 'AREA','mycontent');" class="button_a" ><%=intID%></a></li>
                        <%End IF%>
                    <%End IF%>
                    <%Next%>
                    ...
                    <%IF Cint(PageNo) < TotalPage Then %>
                        <li class="paginate_button"><a href="javascript:showDetails('page=<%=PageNo+1%>','AREA','mycontent');" class="button_a" >
						Next &gt;</a></li>
                        <li class="paginate_button"><a href="javascript:showDetails('page=<%=TotalPage%>','AREA','mycontent');" class="button_a" >
						Last &gt;&gt;</a></li>
                    <%End IF%>
                </ul>
            </div>
