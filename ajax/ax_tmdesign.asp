    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <%
                ...
                do while not rstTMDESIGN.eof and i < PageLen
                ...
                response.write "<td style=""width:2%;text-align:center""><a href='TMDESIGN_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtDesign_ID="& rstTMDESIGN("DESIGN_ID") & "'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
