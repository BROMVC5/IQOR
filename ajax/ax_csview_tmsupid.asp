    ...
    <table id="example1" class="table table-bordered">
        ...
        <tbody>
            ...
            do while not rstUser.eof and i < iRecCount
                ...
                i = i + 1
                response.write "<tr onmouseover=this.bgColor='#FFF59D' onmouseout=this.bgColor='white' onclick=""getValue('" & rstUser("EMP_CODE") & "','txtSup_CODE')"">"
                response.write "<td>" & i + ((PageNo-1)*PageLen) & "</td>"
                response.write "<td>" & rstUser("EMP_CODE") & "</td>"
                response.write "<td>" & rstUser("NAME") & "</td>"
                response.write "<td style='text-align:center'><button id=""btnSelect"" class=""btn btn-primary btn-sm"" onclick=""getValue('" & rstUser("EMP_CODE") & "','txtSup_CODE')"">Select</button></td>"
                response.write "</tr>"
                rstUser.movenext
            loop
