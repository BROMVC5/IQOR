    ...
    <table id="example1" class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th style="width:8%;text-align:center">Property Return</th>
        ...
        <tbody>
            <%     
                ...
                elseif rstOGProp("STATUS") = "R" then
                	response.write "<td style=""text-align:center"">Rejected</td>"
                end if
                response.write "<td style=""text-align:center""><a href='ogprop_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtTicket="& rstOGProp("TICKET_NO") & "'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
                rstOGProp.movenext
                loop
