    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <%
                ...
                response.write "<td style=""width:2%;text-align:center""><a href='tmworkgrp_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtWorkGrp_ID="& rstTMWorkGrp("WORKGRP_ID") & "'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
