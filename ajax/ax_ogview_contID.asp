    ...
    <table id="example1" class="table table-bordered">
        ...
        <tbody>
            <%
                ...
                response.write "<td style='text-align:center'><button id=""btnSelect"" class=""btn btn-primary btn-sm"" onclick=""getValue('" & server.HTMLEncode(rstTMCont("CONT_ID")) & "', '"& sFldName &"')"">Select</button></td>"
                response.write "</tr>"
                rstTMCont.movenext
            loop
