    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <%
                ...
                do while not rstTMShfPlan.eof and i < PageLen
                ...
                response.write "<td style=""width:2%;text-align:center""><a href='tmshfplan_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtShfPlan_ID="& rstTMShfPlan("ShfPlan_ID") & "&Edit=Y'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
