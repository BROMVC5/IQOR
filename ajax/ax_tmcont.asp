    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <%
                ...
                do while not rstTMCont.eof and i < PageLen
                ...
                response.write "<td style=""width:2%;text-align:center""><a href='tmcont_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtCONT_ID="& rstTMCont("CONT_ID") & "'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
                rstTMCont.movenext
            loop
