    ...
    <table id="example1" class="table table-bordered">
        ...
        <tbody>
            ...
            do while not rstUser.eof and i < iRecCount
                ...
                i = i + 1
                response.write "<tr onmouseover=this.bgColor='#FFF59D' onmouseout=this.bgColor='white' onclick=""getValue('" & rstUser("EMP_CODE") & "','txtDepManCode')"">"
