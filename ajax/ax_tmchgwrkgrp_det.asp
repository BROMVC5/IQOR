...
%>
    ...
    <div class="col-sm-12" style="overflow: auto; padding: 0px; margin: 0px">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <%  
                    Set rstTMShfPlan = server.CreateObject("ADODB.RecordSet")    
                    sSQL = "select * from TMSHFPLAN where WORKGRP_ID='" & sID & "' order by WORKGRP_ID" 
                    rstTMShfPlan.Open sSQL, conn, 3, 3
                        do while not rstTMShfPlan.eof 
                            response.write "<tr>"
                                'response.write "<td style='text-align:right'>" & 48 * Cint(sCol) & "</td>"
    ...
    <div class="box-footer">
        <div class="pull-right" >
            ...
            style="width: 150px" onclick="checkempty();">
