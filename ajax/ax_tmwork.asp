    ...
    <table id="example1" class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th style="width:30%">Work Location</th>
        ...
        <tbody>
            <%
                ...
                do while not rstTMWork.eof and i < PageLen
                ...
                response.write "<td style=""width:2%;text-align:center""><a href='tmwork_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtWork_ID="& rstTMWork("Work_ID") & "'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
                rstTMWork.movenext
            loop
