...
sql = "select EMP_CODE, NAME, DT_RESIGN from TMEMPLY "
if sql_1 <> "" then
	sql = sql & sql_1
end if 
        ...
        <div class="row">
            ...
            <div class="col-sm-4 pull-right">
                <div class="input-group">
                    ...
                    <input class="form-control" id="txtSearch_emp" name="txtSearch" value="<%=txtSearch%>" placeholder="Search" maxlength="100" type="text" />
                        <span class="input-group-btn">
                        <button class="btn btn-default" type="submit" name="search" value="Search" onclick="showDetails('page=1','txtEmp_ID','EMP','mycontent');return false;"><i class="fa fa-search"></i>
                        </button>
                    </span>
                </div>
            </div>
    ...
    <table id="example1" class="table table-bordered">
        ...
        <tbody>
            ...
            do while not rstUser.eof and i < iRecCount
                ...
                i = i + 1
                response.write "<tr onmouseover=this.bgColor='#FFF59D' onmouseout=this.bgColor='white' onclick=""getValue1('" & server.HTMLEncode(rstUser("EMP_CODE")) & "', '" & server.HTMLEncode(rstUser("NAME")) & "', '" & rstUser("DT_RESIGN") & "','txtEmp_ID','txtEmp_Name','dt_Resign')"">"
