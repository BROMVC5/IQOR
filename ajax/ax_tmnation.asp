    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            <%
                ...
                do while not rstTMNATION.eof and i < PageLen
                ...
                response.write "<td style=""width:2%;text-align:center""><a href='TMNATION_det.asp?page="& PageNo & "&txtsearch=" & txtSearch & "&txtNATION="& rstTMNATION("NATION") & "'><img src=""dist/img/edit-2-24.png"" /></a></td>"
                response.write "</tr>"
