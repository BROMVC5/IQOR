...
<%
    ...
    sIC = request("txtstring")
  
    if reqForm("btnSubmit") <> "" then
        sIC = reqform("txtNRIC")
        
        sSQL = "delete from VRVEND where NRIC='" & sIC & "'"
        conn.execute sSQL     
        
        sMainURL = "vrvend.asp?"
        sAddURL = "txtNRIC=" & sIC & "&txtSearch=" & sSearch & "&Page=" & iPage 
...
<body>
    <form class="form-horizontal" action="vrvend_del.asp" method="post">
        <input type="hidden" name="txtNRIC" value='<%=sIC%>' />
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <span style="color:red"><h4>Are you sure to delete this NRIC?</h4></span>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
