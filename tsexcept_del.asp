...
<%
    ...
    iAutoInc = request("fldName")
  
    if reqForm("btnSubmit") <> "" then
        sID = reqform("txtAutoInc")
        
        sSQL = "delete from tsexcept where AUTOINC ='" & sID & "'"
        conn.execute sSQL   

        sMainURL = "tsexcept.asp?"
        response.redirect sMainURL 
    End If
...
<body>
    <form class="form-horizontal" action="tsexcept_del.asp" method="post">
