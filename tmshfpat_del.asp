...
<%
    ...
    sSHFPAT_ID = request("txtstring")
  
    if reqForm("btnSubmit") <> "" then
        sID = reqform("txtSHFPAT_ID")
        
        sSQL = "delete from TMSHFPAT where SHFPAT_ID='" & sID & "'"
        conn.execute sSQL     
        
        sMainURL = "tmshfpat.asp?"
        sAddURL = "txtSHFPAT_ID=" & sID & "&txtSearch=" & sSearch & "&Page=" & iPage 
...
<body>
    <form class="form-horizontal" action="tmshfpat_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>Shift Pattern : <% response.write sSHFPAT_ID %></h3></span>
                    <span style="color:red"><h4>Are you sure to delete this Shift Pattern?</h4></span>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
