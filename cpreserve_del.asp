...
<%
    ...
    if reqForm("btnSubmit") <> "" then
        ...
        sSQL = "delete from cpresv where TICKET_NO='" & sTicket_No & "'"
        conn.execute sSQL     
        
        sMainURL = "cpreserve.asp?"
...
<body>
    <form class="form-horizontal" action="cpreserve_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    ...
                    <span style="color:red"><h4>Are you sure to delete this Ticket?</h4></span>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
