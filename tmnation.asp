...
<head>
    ...
    <title>iQOR | Nationality Information</title>
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmnation.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmnation_det.asp');" />
    ...
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmnation.asp?"+str, true);
  	    xhttp.send();
    }
    ...
    function exportReport() {
        ...
        window.open("tmexcel_nation.asp?" + sURL);
	}
