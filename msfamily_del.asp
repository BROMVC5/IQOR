...
<%
    ...
    if reqForm("btnSubmit") <> "" then
        ...
        sSQL = "delete from msfamily where AUTOINC ='" & iAutoInc & "'"
        conn.execute sSQL     
...
<body>
    <form class="form-horizontal" action="msfamily_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>Employee No : <% response.write sEmp_ID %></h3></span>
                    <span style="color:red"><h4>Are you sure to delete this Family Detail?</h4></span>
                </div>
            </div>
        </div>
        <!-- /.box-body -->
