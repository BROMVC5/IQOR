...
<body class="hold-transition skin-blue sidebar-mini">
                                    ...
                                    <div class="row">
                                         <div class="col-sm-3 pull-left">
                                            <div class="input-group">
                                                <input class="form-control" id="txtSearch" name="txtSearch" value="<%=server.htmlencode(sSearch)%>" placeholder="Badge No" maxlength="100" type="text" />
											...
											<div class="form-group">
												<div class="col-sm-13">
													<select name="sBadgeType" id = "sBadgeType" class="form-control" onclick="showContent('page=1')">
														<option value="S" Selected>Shipping - S</option>
														<option value="IN" Selected>Interview - IN</option>
														<option value="C" Selected>Contractor - C</option>
														<option value="T" Selected>Temporary - T</option>
														<option value="VS" Selected>Visitor - VS</option>
														<option value="VN" Selected>Vendor - VN</option>
														<option value="AR" Selected>Auditor - AR</option>
    ...
    function showContent(str) {
		...
		str = str + "&txtBadgeType=" + x
  	    ...
  	    xhttp.open("GET", "ajax/ax_vrout.asp?"+str, true);
  	    xhttp.send();
    }
