...
function showContent(str) {
  	...
  	xhttp.open("GET", "ajax/ax_csemply_info.asp?"+str, true);
  	xhttp.send();
}
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="csemply.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('csemply_det.asp');" />
                                            </div>
                                         </div>
                                         <div class="col-sm-3 pull-right">
                                            <div class="input-group">
                                                <input class="form-control" id="txtSearch" name="txtSearch" value="<%=server.HtmlEncode(sSearch)%>" placeholder="Search" maxlength="15" type="text" />
