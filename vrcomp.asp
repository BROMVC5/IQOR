...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="vrmaster_export.asp" method="POST">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('vrcomp_det.asp');" />
                                            </div>
                                        </div>
										<input type="hidden" name="txtType" id="txtType" value="<%=sType%>">
                                         <div class="col-sm-3 pull-right">
                                            <div class="input-group">
                                                <input class="form-control" id="txtSearch" name="txtSearch" value="<%=server.htmlencode(sSearch)%>" placeholder="Search" maxlength="30" type="text" />
										...
										<button type="submit" class="btn bg-green-active pull-right" style="width: 100px;margin-right: 5px;">Export Excel</button>
                                   </div>
                                </form>
                                <div id="content2">
                                    <!-- CONTENT HERE -->
    ...
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_vrcomp.asp?"+str, true);
  	    xhttp.send();
    }
