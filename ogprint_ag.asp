...
private sub pageHeader()
	...
	response.write "<table cellSpacing=0 cellpadding=0 width=800 >"
		response.write "<tr>"
			response.write "<td width=100 align=left>  Report : Aging Report</td>"
	...
	response.write "<table cellSpacing=0 cellpadding=0 width=800 >"
		...
		response.write "</tr>"	
		response.write "<tr>"
			response.write "<td align=left width='8%'>Ticket No</td>"
			...
			response.write "<td align=left width='2%'></td>"
			response.write "<td align=left width='7%'>Checkout</td>"
...
if not rstOGProp.eof then
	...
	do while not rstOGProp.eof
		...
		response.write "<td>" & fDateLong(rstOGProp("DT_OUT")) & "</td>"
