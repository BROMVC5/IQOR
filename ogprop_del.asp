...
<%
    ...
    if reqForm("btnSubmit") <> "" then
	    ...
	    sSQL = sSQL & "'DEL',"
	    sSQL = sSQL & "'Ticket : " & sTicket & " Requestor : " & sEmpCode & " Destination : " & sDest & " Property Return : " & sRStatus & " Attachment : " & sAttach & "'"
        sSQL = sSQL & ") "	
	    conn.execute sSQL
        
        sSQL = "delete from ogprop where TICKET_NO ='" & sTicket & "'"
        conn.execute sSQL   
        
		sSQL = "delete from ogprop1 where TICKET_NO ='" & sTicket & "'"  
        conn.execute sSQL 
...
<body>
    <form class="form-horizontal" action="ogprop_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>TICKET NO : <% response.write sTicket %></h3></span>
