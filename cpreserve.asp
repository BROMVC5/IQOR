...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="cpreserve.asp" method="POST">
                                    <div class="row">
                                         <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('cpreserve_det.asp');" />
                                            </div>
                                         </div>
                                        ...
                                        <div class="col-sm-2 pull-right">
                                            <div class="form-group">
                                                <div class="col-sm-13">
                                                    <select name="sApprove" id="sApprove" class="form-control" onclick="showContent('page=1')">
    ...
    function showContent(str) {
        ...
        var x = document.getElementById("sApprove").value;

  	    str = str + "&txtSearch=" + document.getElementById("txtSearch").value;
        str = str + "&txtApprove=" +x
  	
  	    xhttp.open("GET", "ajax/ax_cpreserve.asp?"+str, true);
  	    xhttp.send();
    }
