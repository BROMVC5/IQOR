...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="vrreport.asp?type=BL" method="POST">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('vrvend_det.asp');" />
                                            </div>
                                        </div>
    ...
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_vrvend.asp?"+str, true);
  	    xhttp.send();
    }
