...
<%
    ...
    if reqForm("btnSubmit") <> "" then
        sID = reqform("txtEmpCode")
        
        sSQL = "delete from tsemply where EMP_CODE='" & sID & "'"
        conn.execute sSQL   

        sMainURL = "tsemply.asp?"
        sAddURL = "txtEmpCode=" & sID & "&txtSearch=" & sSearch & "&Page=" & iPage 
...
<body>
    <form class="form-horizontal" action="tsemply_del.asp" method="post">
        <input type="hidden" name="txtEmpCode" value='<%=sEmpCode%>' />
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>EMPLOYEE NO : <% response.write sEmpCode %></h3></span>
