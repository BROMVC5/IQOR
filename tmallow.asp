...
<head>
    ...
    <title>iQOR | Allowance Information</title>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            <!-- /.box-header -->
                            <div class="box-body ">
                                <form name="form1" action="tmallow.asp" method="POST">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <div class="pull-left">
                                                <input type="button" class="btn btn-new" value="New" onclick="go('tmallow_det.asp');" />
...
<script>
    function showContent(str) {
  	    ...
  	    xhttp.open("GET", "ajax/ax_tmallow.asp?"+str, true);
  	    xhttp.send();
    }
