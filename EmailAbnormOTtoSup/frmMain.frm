...
Begin VB.Form frmMain 
   Caption         =   "Insert Total Abnormals OTs into Email System"
   ClientHeight    =   3375
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6285
...
Private Sub Form_Load()
    ...
    sURL1 = "http://localhost/tm_sendmail.asp" '=== IQOR SERVER
    
    'sURL1 = "http://localhost/iqor/tm_sendmail.asp" '===BRO server
...
Private Sub Timer1_Timer()
    ...
    If gCounter = 1 Then
       ' AniFile.Open "D:\WEB\IQOR\Graphics\Filemove.avi"
        ...
        AniFile.Close
    ElseIf gCounter = 60 Then '=== How many secs, 60 = 1 minutes
        End
    End If
