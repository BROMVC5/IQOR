...
<%
    Session.Timeout = 1440
 	...
 	dAutoInc = request("pValue1")
	dtDate = request("pValue2")
    ...
    if reqForm("btnSubmit") <> "" then
        ...
        dAutoInc = reqform("txtAutoInc")
 		sType = reqform("sType")
        dtDate = reqform("dtDate")
                       
        sSQL = "delete from csemply1 where AUTOINC='" & dAutoInc & "'"
                
        conn.execute sSQL     
        sMainURL = "csemply_det.asp?"
        sAddURL = "txtEMP_CODE=" & sID & "&txtSearch=" & sSearch & "&Page=" & iPage 

        call URLBox(sMainURL&sAddURL)
    End If
...
<body>
    <form class="form-horizontal" action="cscoupon_del.asp" method="post">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <span style="color:blue"><h3>Date : <% response.write dtDate %></h3></span>
